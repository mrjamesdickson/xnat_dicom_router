...
public class RouterStore {
    ...
    private static final int SCHEMA_VERSION = 3;  // Bumped for DICOM index tables
    ...
    private void createTables() throws SQLException {
        try (Statement stmt = connection.createStatement()) {
            ...
            stmt.execute(
                "INSERT OR IGNORE INTO schema_info (key, value) VALUES ('version', '" + SCHEMA_VERSION + "')");
            ...
            // Index for custom field lookups
    ...
    private void migrateIfNeeded() throws SQLException {
        ...
        if (currentVersion < SCHEMA_VERSION) {
            ...
            setSetting("schema_info", "version", String.valueOf(SCHEMA_VERSION));
        }
    }
    ...
    public void upsertStudy(IndexedStudy study) {
        String sql = "INSERT INTO dicom_studies (study_uid, patient_id, patient_name, study_date, " +
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            stmt.setString(4, study.studyDate);
            stmt.setString(5, study.studyTime);
            stmt.setString(6, study.accessionNumber);
            stmt.setString(7, study.studyDescription);
            stmt.setString(8, study.modalities);
            stmt.setString(9, study.institutionName);
            stmt.setString(10, study.referringPhysician);
            stmt.setInt(11, study.seriesCount);
            stmt.setInt(12, study.instanceCount);
            stmt.setLong(13, study.totalSize);
            stmt.setString(14, study.sourceRoute);
            stmt.setString(15, Instant.now().toString());
            stmt.setString(16, study.filePaths);
            stmt.executeUpdate();
        } catch (SQLException e) {
